package com.example.esd_again.Util;
...
// This class adds the CORS policy and allows request from all origins and add required Access Control Headers to each Response being sent
// Many thanks to this StackOverflow post for this great explanation-True
